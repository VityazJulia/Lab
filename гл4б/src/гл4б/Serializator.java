...
public class Serializator {
    ...
    public boolean serialization(Carrot s, String fileName) {
        boolean flag = false;
    ...
    public Carrot deserialization(String fileName) throws InvalidObjectException {
        ...
        try {
            ...
            // десериализация
            Carrot st = (Carrot) istream.readObject();
            return st;
